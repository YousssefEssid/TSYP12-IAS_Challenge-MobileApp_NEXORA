...
class _LoginPageWidgetState extends State<LoginPageWidget> {
  ...
  void initState() {
    ...
    _model.idCompanyTextController ??= TextEditingController();
    _model.idCompanyFocusNode ??= FocusNode();
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 12.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.idCompanyTextController,
                                    focusNode: _model.idCompanyFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .idCompanyTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
